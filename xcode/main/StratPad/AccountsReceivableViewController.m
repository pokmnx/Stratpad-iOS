//
//  AccountsReceivableViewController.m
//  StratPad
//
...
#import "AccountsReceivableViewController.h"
...
@interface AccountsReceivableViewController ()
...
@implementation AccountsReceivableViewController
...
- (void)viewDidLoad
{
    ...
    _slider.value = _financials.accountsReceivableTerm.floatValue;
    [_lblDays setText:[NSString stringWithFormat:_daysTextFormat, _financials.accountsReceivableTerm.integerValue]];
...
- (IBAction)sliderChanged:(id)sender {
    ...
    _financials.accountsReceivableTerm = [NSNumber numberWithInteger:honedValue];
}
