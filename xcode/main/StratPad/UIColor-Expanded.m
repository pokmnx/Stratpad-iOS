...
-(UIColor*)lighterColorByFraction:(CGFloat)fraction
{
    struct hsv_color hsv;
	struct rgb_color rgb;
	rgb.r = [self red];
	...
	hsv = [UIColor HSVfromRGB: rgb];
    UIColor *lighterColor = [UIColor colorWithHue:hsv.hue/360
                                       saturation:MIN(hsv.sat - fraction, 1.0)
                                       brightness:MIN(hsv.val + fraction, 1.0)
                                            alpha:1.0];
    return lighterColor;
}
...
-(UIColor*)darkerColor
{
	...
	rgb.b = [self blue];
	hsv = [UIColor HSVfromRGB: rgb];
    UIColor *darkerColor = [UIColor colorWithHue:hsv.hue/360 
                                      saturation:MIN(hsv.sat + 0.25, 1.0) 
                                      brightness:MIN(hsv.val - 0.25, 1.0) 
                                           alpha:1.0];
    return darkerColor;
