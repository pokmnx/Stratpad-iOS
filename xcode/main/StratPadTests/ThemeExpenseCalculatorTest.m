...
@interface ThemeExpenseCalculatorTest : SenTestCase {
}
@end


@implementation ThemeExpenseCalculatorTest
 ...
 * only the first month of the theme will contain the one time expenses value.
 */
...
{    
    ...
    theme.researchAndDevelopmentOneTime = [NSNumber numberWithDouble:200];
    [stratFile addThemesObject:theme];
    
    ThemeRADCalculator *calculator = [[ThemeRADCalculator alloc] initWithTheme:theme andIsOptimistic:YES];        
...
{    
    ...
    ThemeRADCalculator *calculator = [[ThemeRADCalculator alloc] initWithTheme:theme andIsOptimistic:NO];        
 ...
 * every month of the theme will contain the monthly expenses value.
 */
- (void)testCalculateMonthlyValues1
{    
    StratFile *stratFile = [TestSupport createEmptyStratFile];
    Theme *theme = (Theme*)[DataManager createManagedInstance:NSStringFromClass([Theme class])];
    theme.researchAndDevelopmentMonthly = [NSNumber numberWithDouble:2000];
    [stratFile addThemesObject:theme];
 ...
 * the quarter expenses value will occur in months 0, 3, 6, ... (i.e., the first month of each quarter)
 */
- (void)testCalculateQuarterlyValues1
{    
    StratFile *stratFile = [TestSupport createEmptyStratFile];
    Theme *theme = (Theme*)[DataManager createManagedInstance:NSStringFromClass([Theme class])];
    theme.researchAndDevelopmentQuarterly = [NSNumber numberWithDouble:20000];
    [stratFile addThemesObject:theme];
 ...
 * is expected that the quarter expenses value will occur in months 2 and 5 (i.e., the last month of each quarter)
 */
 ...
 * is expected that the quarter expenses value will occur in months 2, 5, and 7 (i.e., the last month of each of the first two quarters, 
 ...
 * It is expected that the annual expenses value will occur in months 0, 12, ... (i.e., the first month of each year)
 */
- (void)testCalculateAnnualValues1
{    
    StratFile *stratFile = [TestSupport createEmptyStratFile];
    Theme *theme = (Theme*)[DataManager createManagedInstance:NSStringFromClass([Theme class])];
    theme.researchAndDevelopmentAnnually = [NSNumber numberWithDouble:200000];
    [stratFile addThemesObject:theme];
 ...
 * is expected that the annual expenses value will occur the first month of each year, and in the last month of the theme.
 */
 ...
 * is expected that the annual expenses value will occur the last month of the theme.
 */
