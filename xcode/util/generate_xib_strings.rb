...
# cd en.lproj; ibtool --generate-strings-file "YammerOAuth2LoginViewController.strings" "YammerOAuth2LoginViewController.xib"
require 'FileUtils'
 
# Check for arguments.
if ARGV.length != 1
  puts "Usage: ruby generate_xib_strings.rb path_to_lproj"
  # eg. cd src/xcode/main/StratPad; ruby ../../util/generate_xib_strings.rb en.lproj
  exit
end
